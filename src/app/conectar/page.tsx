    ...
    <section className="text-left flex flex-col h-auto w-full bg-black pt-2 border border-t-0 border-zinc-700">
      ...
      <div>
        {followStatuses.map((user) => (
          <div key={user.id} className="flex flex-row justify-between w-full hover:bg-white/5 relative p-4">
            <Link href={`/perfil/${user.user_name}`} className="absolute inset-0 z-0"></Link>
