  ...
  return (
    ...
    >
      ...
      {isDropdownOpen && (
        <div
          ref={dropdownRef}
          className="absolute top-0 left-0 transform translate-y-full md:-translate-y-full border border-white/50 text-white/90 w-auto rounded-xl shadow-lg bg-black ring-1 ring-black ring-opacity-5 z-20"
        >
          <div
            role="menu"
