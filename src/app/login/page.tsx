    ...
    <main className='relative flex flex-col flex-1 m-0 max-h-screen w-screen items-center overflow-hidden'>
      <section className='flex flex-row flex-1 items-center'>
        ...
        <div className='flex w-full flex-col gap-10 items-start p-20'>
          ...
          <button className='font-bold bg-sky-500 rounded-full p-2 w-72 hover:bg-sky-500/90 transition' onClick={() => setIsModalOpen(true)}>Crear cuenta</button>
          ...
          <button className='font-bold text-sky-500 bg-black border border-zinc-500/90 rounded-full p-2 w-72 hover:bg-sky-500/10 transition'>Iniciar sesión</button>
        </div>
      </section>
